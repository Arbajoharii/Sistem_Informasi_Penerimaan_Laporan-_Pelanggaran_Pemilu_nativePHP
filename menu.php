...
<nav class="navbar navbar-inverse navbar-fixed-top">
    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="?page=utama">SI Penerimaan Laporan Pelanggaran Pemilu Batu Bara</a>
        </div>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="?page=arsip&actions=tampil">Arsip Penerimaan Laporan</a></li>
